...
public class CommingSoonActivity extends AppCompatActivity {
    ...
    @BindView(R.id.txt_comingsoon)
    CustomTextView txtComingsoon;
    @BindView(R.id.btn_comingsoon)
    CustomButton btnComingsoon;
    ...
    @OnClick(R.id.btn_comingsoon)
    public void onViewClicked() {
        Intent intent=new Intent(CommingSoonActivity.this,MainActivity.class);
